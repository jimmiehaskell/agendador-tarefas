...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        dev.jimmiehaskell.agendadortarefas.infrastructure.security.JwtRequestFilter jwtRequestFilter = new dev.jimmiehaskell.agendadortarefas.infrastructure.security.JwtRequestFilter(jwtUtil, userDetailsService);
